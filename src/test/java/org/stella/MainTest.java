...
class MainTest {
    ...
    @ValueSource(strings = {
            ...
            "tests/my-well-typed/variant-subtype.stella",
            "tests/my-well-typed/top.stella",
...
//"tests/subtyping/well-typed/subtyping-8.stella"
    ...
    @ValueSource(strings = {
            ...
            "tests/my-ill-typed/variant-subtype.stella",
            "tests/my-ill-typed/top.stella",
            "tests/my-ill-typed/bottom.stella",
